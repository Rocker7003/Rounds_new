...
public class BombEntity extends PathfinderMob implements GeoEntity {
   ...
   public BombEntity(SpawnEntity packet, Level world) {
      this((EntityType<BombEntity>)RoundsNewModEntities.BOMB.get(), world);
   }
