...
import net.mcreator.roundsnew.procedures.SdProcedure;
...
@EventBusSubscriber
public class StartgamCommand {
   @SubscribeEvent
   public static void registerCommand(RegisterCommandsEvent event) {
      event.getDispatcher()
         .register((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("start_g").requires(s -> s.hasPermission(2))).executes(arguments -> {
            ...
            SdProcedure.execute(world, x, y, z);
            return 0;
         }));
   }
}
