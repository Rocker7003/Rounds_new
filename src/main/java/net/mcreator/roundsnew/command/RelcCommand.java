...
import net.mcreator.roundsnew.procedures.ClearplayerProcedure;
...
@EventBusSubscriber
public class RelcCommand {
   @SubscribeEvent
   public static void registerCommand(RegisterCommandsEvent event) {
      event.getDispatcher().register((LiteralArgumentBuilder)Commands.literal("relc").executes(arguments -> {
