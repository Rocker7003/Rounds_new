...
import net.mcreator.roundsnew.procedures.CleacomProcedure;
...
@EventBusSubscriber
public class ClearcomandCommand {
   @SubscribeEvent
   public static void registerCommand(RegisterCommandsEvent event) {
      event.getDispatcher()
         .register((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("clearcomand").requires(s -> s.hasPermission(2))).executes(arguments -> {
